...
const resources = {
  ...
  hi: {
    translation: {
      ...
      Recent: "हालिया",
      Article: "लेख",
      "Posts by tag": "टैग द्वारा पोस्ट: {{tag}}",
      "Posts by category": "श्रेणी में पोस्ट: {{category}}",
      More: "और…",
      "Search results": "निम्नलिखित क्वेरी भागों के लिए खोज परिणाम: {{parts}}",
      "Empty query": "अरे, खाली क्वेरी…",
      "No content": "अरे! हमारे पास अभी ऐसा कोई कंटेंट नहीं है। लेकिन बाद में वापस आएं। शायद हम इसके बारे में लिखें।",
      posts: "पोस्ट्स",
      tags: "टैग्स",
      category: "श्रेणी",
      search: "खोजें",
      source: "स्रोत",
      "count minutes read_0": "{{count}} मिनट पढ़ें",
      "count minutes read_1": "{{count}} मिनट पढ़ें",
      "count minutes read_2": "{{count}} मिनट पढ़ें",
      "Not found": "404 - ओह! हम वह पृष्ठ नहीं ढूंढ सके :(",
