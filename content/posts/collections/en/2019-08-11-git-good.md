      ...
      <tr>
         ...
         <td data-label="Description">
            ...
            <ul>
               ...
               <li>
                  <code>-m 1</code> to select first the parent as a mainline (<i>usually master</i>).
               </li>
            </ul>
         </td>
      ...
      <tr>
         ...
         <td data-label="Description">Cherry-pick a commit with a referenced commit message. Use:
            <ul>
               ...
               <li>
                  <code>-m 1</code> to select the first parent as a mainline (<i>usually</i> master).
               </li>
            </ul>
          </td>
         <td data-label="Warning">Can cause conflicts.</td>
